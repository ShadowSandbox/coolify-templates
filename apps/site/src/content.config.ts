  ...
  schema: z.object({
    ...
    security: z
      ...
      .default({
        ...
        applicationExposure: [
          { label: 'Administration dashboard', value: 'Included' },
          { label: 'Dashboard authentication', value: 'Enabled' },
          { label: 'Default credentials', value: 'Generated by Coolify' },
          { label: 'Public registration', value: 'Not available' },
          { label: 'HTTPS', value: 'Provided by the Coolify proxy' },
